...
void Custom_STM_App_Notification(Custom_STM_App_Notification_evt_t *pNotification)
{
  ...
  switch (pNotification->Custom_Evt_Opcode)
  {
    ...
    case CUSTOM_STM_DL_CHAR_READ_EVT:
      ...
      /* USER CODE END CUSTOM_STM_DL_CHAR_READ_EVT */
      break;

    case CUSTOM_STM_DL_CHAR_WRITE_NO_RESP_EVT:
      /* USER CODE BEGIN CUSTOM_STM_DL_CHAR_WRITE_NO_RESP_EVT */

      /* USER CODE END CUSTOM_STM_DL_CHAR_WRITE_NO_RESP_EVT */
      break;

    case CUSTOM_STM_BS_CHAR_READ_EVT:
      /* USER CODE BEGIN CUSTOM_STM_BS_CHAR_READ_EVT */

      /* USER CODE END CUSTOM_STM_BS_CHAR_READ_EVT */
      break;

    case CUSTOM_STM_BS_CHAR_WRITE_NO_RESP_EVT:
